 ...
 */
Glyph* fill_glyph P((Glyph*, unsigned char[2], endianness));
...
/**
* Fill the utf8 glyph with the by information
*
* @param glyph The glyph to be filled
* @param Code point of the glyph
*/
